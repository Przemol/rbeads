#Load system files
bam <- system.file("extdata", "GSM1208360_chrI_100Kb_q5_sample.bam", package="rbeads")
bw <- system.file("extdata", "Ce10_HiSeqFRMInput_UNIQ_bin25bp_chrI_100Kb_sample.bw", package="rbeads")
map <- system.file("extdata", "ce10_mappability_chrI_100Kb_sample.bw", package="rbeads")
fa <- system.file("extdata", "ce10_chrI_100Kb_sample.fa", package="rbeads")
...
test_that("Test summed input", {
  ...
  tmp <- file.path(tempdir(), 'SummedInput')
  ...
  sumBAMinputs(c(bam, bam, bam), map, fa, out_name = tmp)
